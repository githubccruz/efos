...
namespace Efos
{
    public partial class FormMantenimientoProvincia : FormBaseMantenimientoRegion
    {
        public FormMantenimientoProvincia()
        {
        ...
        public FormMantenimientoProvincia(string titulo)
        {
            InicializarFormulario();
